...
import './Project1_Details.css'; // 여기에 CSS 코드를 작성할 겁니다.
    ...
    return (
        <div className="details-container">
            ...
            <div className="image-container">
                ...
                <h2>사용한 툴</h2>
                <p/>
                <img src="/images/1st/stack-project MenuTree.png"
                    onClick={() => openModal("/images/1st/stack-project MenuTree.png")}
                    className="clickable-image" />
                <h2>메뉴 트리</h2>
                <p/>
                <img src="/images/1st/1차 개발일정.png"
                    onClick={() => openModal("/images/1st/1차 개발일정.png")}
                    className="clickable-image" />
                <h2>개발 일정</h2>
                <p/>
                <img src="/images/1st/1차 요구사항 명세서.png"
                    onClick={() => openModal("/images/1st/1차 요구사항 명세서.png")}
                    className="clickable-image" />
                <h2>요구사항 명세서</h2>
                <p/>
                <h2>경험한 문제와 해결방안</h2>
